                            ...
                            <div class="CSE-form-wrapper">
                                <form id="addform" method="post">
                                        ...
                                        <div class="CSE-input-flex" style="margin-bottom:10px">
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    <option value="CSE-Subprofessional">CSE-Subprofessional Exam</option>
                                            ...
                                            <div>
                                                ...
                                                <select
                                                    ...
                                                    <option value="COMEX">Computer Examination</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div id="step3" class="CSE-form-step-inactive">
                                        ...
                                        <div class="CSE-input-flex" id="examdiv0">
                                            ...
                                            <div class="CSE-input-flex" style="margin-top: 0px;">
                                                ...
                                                <div>
                                                    <label for="examdate0" class="CSE-form-label">Date of Examination </label>
                                                    <input
                                                        type="date"
                                                        name="examdate"
                                    ...
                                    <div class="CSE-form-btn-wrapper">
                                        <button class="CSE-back-btn" id="prevbtn" hidden>
                                            Back
                                        </button>

                                        <button class="CSE-back-btn" id="nextbtn">
                                            Next
                                        </button>

                                        <button class="CSE-back-btn" id="subbtn" hidden>
                                            Submit
                                        </button>
                                    </div>
                                </form>
...
<script>
    ...
    function validateStep(activeId) {
        var isValid = true;
        $("#" + activeId + " .CSE-form-input").each(function () {
